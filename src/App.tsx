    ...
    <>
      ...
      <div className="projectSection">
        ...
        <div className="projectCards">
          <ProjectCard
            ...
            ImageSrc="./Portfolio/PortfolioImg.png"
          ...
          <ProjectCard
            ...
            ImageSrc="./Portfolio/DeepLearning.png"
          ...
          <ProjectCard
            ...
            ProjectTitle="Slime"
            ImageSrc="./Portfolio/SlimeGame.png"
          ...
          <ProjectCard
            ...
            ImageSrc="./Portfolio/ApprAIse3.png"
            ...
            ProjectLink="https://github.com/adoante/apprAIse"
          />

          <ProjectCard
            TimeFrame="February 28, 2025 - May 23, 2025"
            ProjectTitle="Rex Run"
            ImageSrc="./Portfolio/RexRunGame.png"
            ...
            ProjectLink="https://github.com/adoante/2D-Game"
          />
          <ProjectCard
            TimeFrame="June 3, 2024 - August 23, 2024"
            ProjectTitle="ONE Project"
            ImageSrc="./Portfolio/OneProject.png"
      ...
      <div className="skillSection">
        ...
        <div className="skills">
          <Skill ImageSrc="./Portfolio/cPlusPlus.png" SkillName="C++" />
          <Skill ImageSrc="./Portfolio/java.png" SkillName="Java" />
          <Skill ImageSrc="./Portfolio/python.png" SkillName="Python" />
          <Skill ImageSrc="./Portfolio/php.png" SkillName="PHP" />
          <Skill ImageSrc="./Portfolio/database.png" SkillName="SQL" />
          <Skill ImageSrc="./Portfolio/js.png" SkillName="Javascript" />
          <Skill ImageSrc="./Portfolio/typescript.png" SkillName="Typescipt" />
          <Skill ImageSrc="./Portfolio/html.png" SkillName="HTML" />
          <Skill ImageSrc="./Portfolio/css-3.png" SkillName="CSS" />
          <Skill ImageSrc="./Portfolio/React-icon.svg.png" SkillName="React" />
          <Skill ImageSrc="./Portfolio/git.png" SkillName="Git" />
          <Skill ImageSrc="./Portfolio/github.png" SkillName="GitHub" />
        </div>
      </div>
      <div className="techExperienceSection">
        ...
        <div className="Experiences">
          <ExperienceCard
            ImageSrc="./Portfolio/Logo-navy (2).png"
